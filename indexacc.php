  ...
  <!-- Facebook and Twitter integration -->
	...
	<body>
                                ...
                                <nav id="colorlib-main-menu" role="navigation">
                                    <form name="acc_btn" method="get" action="indexacc.php">
                                        ...
                                        <ul class="navigation">
                                                ...
                                                <li class="n1">
                                                    <input name="sub1" type="submit" value="Экономика"/>
                                                </li>
                                                <li class="n2"><input class="main" name="sub2" type="submit" value="Налоги"/></li>
        ...
        <!--				<ul>
                     ...
                     <?php if(isset($_REQUEST['sub1']) or isset($_REQUEST['sub2']) or isset($_REQUEST['sub3'])){?>     
                                                ...
                                                <div class="row">
                                                        <div class="col-md-5">
                                                                <div class="blog-entry animate-box">
                                                                        <div class="blog-img" style="background-image: url(<?php echo $stackimage1[0]; ?>);">
                                                                                <div class="desc text-center">
                                                                                    
<!--                                                                                        <p class="tag"><span>Sports</span></p>-->
                                                                                        <h2 class="head-article"><a href="<?php echo $stacklink1[0]; ?>"><?php echo $stacktitle1[0]; ?></a></h2>
                                                        ...
                                                        <div class="col-md-7">
                                                                <div class="row">
                                                                        <div class="col-md-12">
                                                                                <div class="blog-entry animate-box">
                                                                                        <div class="blog-img blog-img2" style="background-image: url(<?php echo $stackimage1[1]; ?>);">
                                                                                                <div class="desc text-center">
<!--                                                                                                        <p class="tag"><span>Place</span></p>-->
                                                                                                        <h2 class="head-article"><a href="<?php echo $stacklink1[1]; ?>"><?php echo $stacktitle1[1]; ?></a></h2>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                                <div class="blog-entry animate-box">
                                                                                        <div class="blog-img blog-img2" style="background-image: url(<?php echo $stackimage1[2]; ?>);">
                                                                                                <div class="desc text-center">
<!--                                                                                                        <p class="tag"><span>Place</span></p>-->
                                                                                                        <h2 class="head-article"><a href="<?php echo $stacklink1[2]; ?>"><?php echo $stacktitle1[2]; ?></a></h2>
